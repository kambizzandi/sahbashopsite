...
return [
  ...
  'Missing required arguments: {params}' => 'فاقد پارامترهای مورد نیاز: {params}',
  ...
  'Please fix the following errors:' => 'لطفا خطاهای زیر را رفع کنید:',
  ...
  'The verification code is incorrect.' => 'کد تایید اشتباه است.',
  'Total <b>{count, number}</b> {count, plural, one{item} other{items}}.' => 'مجموع <b>{count, number}</b> مورد.',
  'Unable to verify your data submission.' => 'قادر به تایید اطلاعات ارسالی شما نمی‌باشد.',
  ...
  '{nFormatted} {n, plural, =1{gibibyte} other{gibibytes}}' => '{nFormatted} گیگابایت',
  '{nFormatted} {n, plural, =1{gigabyte} other{gigabytes}}' => '{nFormatted} گیگابایت',
  '{nFormatted} {n, plural, =1{kibibyte} other{kibibytes}}' => '{nFormatted} کیلوبایت',
  '{nFormatted} {n, plural, =1{kilobyte} other{kilobytes}}' => '{nFormatted} کیلوبایت',
  '{nFormatted} {n, plural, =1{mebibyte} other{mebibytes}}' => '{nFormatted} مگابایت',
  '{nFormatted} {n, plural, =1{megabyte} other{megabytes}}' => '{nFormatted} مگابایت',
  '{nFormatted} {n, plural, =1{pebibyte} other{pebibytes}}' => '{nFormatted} پتابایت',
  '{nFormatted} {n, plural, =1{petabyte} other{petabytes}}' => '{nFormatted} پتابایت',
  '{nFormatted} {n, plural, =1{tebibyte} other{tebibytes}}' => '{nFormatted} ترابایت',
